...
- **P3(콜드 스탬피드)에서 특히 크게 작용할 것으로 예상된다.** 랭킹 미스 1건이 8 문장을 유발한다.
  > **확인됨** — P3-cold 실측에서 분산 락이 감싸는 랭킹 쿼리는 flush당 1회로 수렴했지만, 락 밖의 아이템 경로(나머지 7문장)는 **flush마다 7~37회 중복 실행**됐다. 즉 락이 지키는 범위가 8문장 중 1문장뿐이라는 것이 이 N+1 때문에 드러났다([scenarios.md](scenarios.md)의 "락이 지키는 범위는 8문장 중 1문장이다").
