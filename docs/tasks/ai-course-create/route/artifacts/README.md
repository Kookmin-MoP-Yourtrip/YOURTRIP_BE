# 동선 개선 효과 실측 산출물 (ROADMAP 3-7)

[STEP-3-route-optimizer.md](../../steps/STEP-3-route-optimizer.md)의 "동선 개선 효과 실측" 절과 판정 8이 근거로 삼는 원본이다. 문서의 표를 의심하면 여기서 직접 재집계할 수 있다.
...
| `route-optimization-effect-pipeline-20260826.csv` | 90행 | **결과.** day 하나가 한 행이고 세 팔의 거리·교차·역행이 나란히 있다 |
