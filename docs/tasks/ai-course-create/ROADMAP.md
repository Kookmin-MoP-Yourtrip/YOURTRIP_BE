...
| OpenAI 단일 호출 | 2단계 직후 | 모델 교체 효과 | **자동 프록시 6.4%** (세탁분은 수동 검증 대기) |
...
>
> **복합 지표(25.6%와 같은 정의)는 아직 미완성이다** — 세탁된 환각률은 `manual-verification-*.csv` 40건을 사람이 채워야 나온다. 지금 비교 가능한 짝은 **19.8% ↔ 6.4%**다.
>
