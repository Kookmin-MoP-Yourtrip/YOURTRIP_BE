...
> 상세 실행 기록은 [STEP-3-route-optimizer.md](steps/STEP-3-route-optimizer.md) 참고 — 설계가 비워둔 계수 셋을 정하는 과정과, 식사 윈도우 배정의 첫 구현이 벌점의 목적과 정반대였던 사건. **3-7은 8단계 이후에 소급해 더한 항목이다**(3-6까지가 답한 것은 속도뿐이었다).
...
- [route/artifacts/README.md](route/artifacts/README.md) — 3-7 동선 개선 효과 실측의 원본 산출물. 목표 3의 근거
